...
function init() {
  ...
  let texture_bk = new THREE.TextureLoader().load("/material/skyBoxTex/Daylight Box_Front.bmp");
  let texture_up = new THREE.TextureLoader().load("/material/skyBoxTex/Daylight Box_Front.bmp");
  let texture_dn = new THREE.TextureLoader().load("/material/skyBoxTex/Daylight Box_Front.bmp");
  let texture_rt = new THREE.TextureLoader().load("/material/skyBoxTex/Daylight Box_Front.bmp");
  let texture_lf = new THREE.TextureLoader().load("/material/skyBoxTex/Daylight Box_Front.bmp");
